...
namespace Code.TileSystem
{
    public class WorkerMenager
    {
        ...
        public bool UpdateWorkerAssignment(ICollectable building)
        {
        ...
        public bool RemoveWorkerAssignment(ICollectable building)
        {
            var worker = _workerViews.Find(x => x.ResourceType == building.ResourceType && x.BuildingType == building.BuildingTypes);
        ...
        public void RemoveAllWorkerAssignment(ICollectable building)
        {
            var workers = _workerViews.FindAll(x => x.BuildingType == building.BuildingTypes || x.ResourceType == building.ResourceType);
