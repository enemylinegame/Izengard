...
namespace Wave
{
    public class WaveCalculator : IWaveCalculator
    {
        ...
        public WaveCalculator(WaveSettings waveSettings)
        {
        ...
        {
            return _waveSettings.WaveBaseCost + Mathf.Pow(_waveSettings.WaveBaseCost * (waveNumber - 1), _waveSettings.Сoefficient);
        }
    }
}