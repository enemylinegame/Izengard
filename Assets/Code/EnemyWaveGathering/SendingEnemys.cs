...
namespace Wave
{
    public class SendingEnemys : ISendingEnemys
    {
        ...
        public SendingEnemys(IEnemyAIController enemyAIController, GeneratorLevelController levelGenerator)
        {
            _enemySpawnSettings = Resources.Load<EnemySpawnSettings>(nameof(EnemySpawnSettings));
