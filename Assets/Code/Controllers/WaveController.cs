...
public class WaveController : IOnController, IDisposable, IOnUpdate, IOnFixedUpdate, IDowntimeChecker
{
    ...
    public WaveController(GeneratorLevelController levelGenerator, GameConfig gameConfig, RightUI rightUI, Transform btnParents)
    {
        ...
        _waveGathering = new WaveGatheringController(_levelGenerator, _enemyAIController, _bulletsController);
        _sendingEnemys = new SendingEnemys(_enemyAIController, _levelGenerator);
        ...
        _peacefulPhaseWaiting = new PeacefulPhaseWaiting(phasesSettings.PeacefulPhaseDuration, timeCountShower.TimeCountShow);
        _peacefulPhaseWaiting.PhaseEnded += OnPeacefulPhaseEnding;
        _preparatoryPhaseWaiting = new PreparatoryPhaseWaiting(phasesSettings.PreparatoryPhaseDuration, timeCountShower.TimeCountShow, this);
